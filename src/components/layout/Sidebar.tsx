...
const navItems = [
  ...
  { to: '/app/timeline', label: 'Comeback Timeline', icon: Calendar },
  { to: '/app/dna', label: 'Recovery DNA', icon: Activity },
  { to: '/app/mountain', label: 'Recovery Mountain', icon: MountainIcon },
  { to: '/app/replay', label: 'Recovery Replay', icon: Play },
  { to: '/app/victories', label: 'Small Victories', icon: Trophy },
  { to: '/app/letter', label: 'Future Self', icon: Mail },
